class sanity_sequence_arith extends uvm_sequence #(trans);
  `uvm_object_utils(sanity_sequence_arith)
  
  function new(string name = "sanity_sequence_arith");
    super.new(name);
  endfunction
  
  task body();
    $display("\n\n ======================================================= START OF SEQUENCE sanity_sequence_arith ================================================================\n\n");
...
class sanity_sequence_logic extends uvm_sequence #(trans);
  `uvm_object_utils(sanity_sequence_logic)
  
  function new(string name = "sanity_sequence_logic");
    super.new(name);
  endfunction
  
  task body();
  
    $display("\n\n ======================================================== START OF SEQUENCE sanity_sequence_logic ===================================================================== \n\n");
